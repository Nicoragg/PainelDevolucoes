...
<section>
<form method="post" action="controllers/DevolucaoController.php?action=create" enctype="multipart/form-data">
    ...
    <input type="text" id="loja" name="loja" required list="lista-lojas">
    ...
    <input type="text" name="valor" id="valor" oninput="formatarMoeda(this)">
    <script>
    ...
    <select id="status" name="status">
        ...
        <option value="ERRO DE PROCEDIMENTO - GERAR VALE LOJA">ERRO DE PROCEDIMENTO - GERAR VALE LOJA</option>
        <option value="AGUARDANDO COLETA">AGUARDANDO COLETA</option>
        <option value="AGUARDANDO PAGAMENTO">AGUARDANDO PAGAMENTO</option>
        <option value="NEGADO FORNECEDOR">NEGADO FORNECEDOR</option>
        <option value="PROCESSO FINALIZADO - CRÉDITO CONFIRMADO">PROCESSO FINALIZADO - CRÉDITO CONFIRMADO</option>
        <option value="PROCESSO FINALIZADO - SEM PAGAMENTO">PROCESSO FINALIZADO - SEM PAGAMENTO</option>
    </select>
    ...
    <select id="motivo" name="motivo">
        ...
        <option value="POLITICA DE TROCA">Política de Troca</option>
        <option value="PRÉ VENCIDO">Pré Vencido</option>
        <option value="DIVERGÊNCIA PEDIDO DE COMPRAS">Divergência Pedido de Compras</option>
    </select>

    <label for="observacao">Observação</label>
    <textarea id="observacao" name="observacao"><?= htmlspecialchars($devolucao['observacao'] ?? ''); ?></textarea>

    <label for="comprovante">Comprovante de Pagamento (PDF ou Imagem)</label>
